package nl.mediamonkey.managers {
	 ...
	 * import nl.mediamonkey.managers.PopUpFactory;
	 * 
	 ...
	 * 
	 * var popup:IFlexDisplayObject = PopUpFactory.createPopUpFrom(MyPopUpForm, initObject);
	...
	*/
	...
	public class PopUpFactory {
		...
		public static function createPopUpFrom(className:Class, initObject:Object=null, target:DisplayObject=null, childList:String=null):IFlexDisplayObject {
			const view:IUIComponent = new className();
			return addPopUp(view, initObject, target, childList);
		}
